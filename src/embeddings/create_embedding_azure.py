...
from src.utils.azure_openai_embed_client import get_embedding, get_embeddings_batch, DEFAULT_MODEL
...
if __name__ == "__main__":
    ...
    output_filename = f"article_embeddings_azure_{model_name_safe}.npz"
